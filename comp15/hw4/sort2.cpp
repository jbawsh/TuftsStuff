...
//  InsertionSort.cpp
//  
//  Sorts integers using the InsertionSort algorithm by taking the first
//  element of the unsorted section every time and finding where it should be
//  inserted into the sorted section of the array and then moving everything
//  over as necessary.
//
//  Name: James McCants
//  Date: 5/6/14
